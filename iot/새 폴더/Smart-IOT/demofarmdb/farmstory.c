...
int main (void)
{
	...
	while(1)
	{
		...
		sprintf(query,"insert into tfarmsensorvalue values (null, now(), now(),%d, %d, %d)", curtemp,curhumid, light);
		printf("insert into tfarmsensorvalue values (null, now(), now(),%d,%d, %d)\n", curtemp, curhumid, light);
